...
#ifndef SALONJOYSTICK3D_SWIFT_H
#define SALONJOYSTICK3D_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SalonJoystick3D",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class MTKView;
SWIFT_CLASS("_TtC15SalonJoystick3D16MetalRayRenderer")
@interface MetalRayRenderer : NSObject <MTKViewDelegate>
